...
// ------------------------------------------
  ...
  $sql = "CREATE TABLE publication(PK_post_id INT AUTO_INCREMENT, FK_utilisateur_mail VARCHAR(50), titre VARCHAR(50) NOT NULL, message VARCHAR(50) NOT NULL, PRIMARY KEY(PK_post_id), FOREIGN KEY(FK_utilisateur_mail) REFERENCES utilisateur(mail))";
  // use exec() because no results are returned
  $conn->exec($sql);
...
// ------------------------------------------
  ...
  $sql = "CREATE TABLE photo(PK_photo_id INT AUTO_INCREMENT, FK_utilisateur_mail VARCHAR(50), titre VARCHAR(50) NOT NULL, FK_post_id INT, PRIMARY KEY(PK_photo_id), FOREIGN KEY(FK_utilisateur_mail) REFERENCES utilisateur(mail), FOREIGN KEY(FK_post_id) REFERENCES publication(PK_post_id))";
  // use exec() because no results are returned
  $conn->exec($sql);
  echo "3/8 Table \"photo\" created </br>";

  // ------------------------------------------

  $sql=("DROP TABLE IF EXISTS publier ");
  $conn->exec($sql);

  $sql = "CREATE TABLE publier(FK_utilisateur_mail VARCHAR(50),FK_post_id INT,date_publication DATE NOT NULL,PRIMARY KEY(FK_utilisateur_mail, FK_post_id),FOREIGN KEY(FK_utilisateur_mail) REFERENCES utilisateur(mail),FOREIGN KEY(FK_post_id) REFERENCES publication(PK_post_id))";
  // use exec() because no results are returned
  $conn->exec($sql);
  echo "4/8 Table \"publier\" created </br>";
  ...
  // use exec() because no results are returned
  $conn->exec($sql);
  echo "5/8 Table \"suivre\" created </br>";
  ...
  // use exec() because no results are returned
  $conn->exec($sql);
  echo "6/8 Table \"aimer\" created </br>";
  ...
  // use exec() because no results are returned
  $conn->exec($sql);
  echo "7/8 Table \"commenter\" created </br>";
  ...
  $sql = "CREATE TABLE partager(FK_utilisateur_mail VARCHAR(50),FK_post_id INT,date_partage DATE NOT NULL,PRIMARY KEY(FK_utilisateur_mail, FK_post_id),FOREIGN KEY(FK_utilisateur_mail) REFERENCES utilisateur(mail),FOREIGN KEY(FK_post_id) REFERENCES publication(PK_post_id))";
  // use exec() because no results are returned
  $conn->exec($sql);
  echo "8/8 Table \"partager\" created </br>";
